  ...
  return (
    <div className="d-flex align-items-center justify-content-center h-100 p-4 max">
      <div className="d-flex align-items-center justify-content-end  flex-column border border-success p-3 rounded col-12 col-sm-6 col-md-6 col-lg-3 ">
        ...
        {/* <div className="fw-lighter" style={{fontSize:'12px'}}>TXNID: {data?.txnid}</div> */}
        {/* <div
          className="fw-lighter d-flex align-items-center gap-2"
          style={{ fontSize: "14px" }}
        >
          TXNID: <span className="text-primary">{data?.txnid}</span>
          <FaRegCopy
            onClick={() => {
              navigator.clipboard.writeText(data?.txnid);
